...
def produce_performance_metrics_over_multiple_datasets(perturbed_df, classifier, X_test, y_test, y_cal, alpha, class_labels):
    ...
    for index, row in perturbed_df.iterrows():
...
def plot_conformal_explainer(classifier, X_Cal, y_cal, X_test, y_test, alpha, class_labels, type_of_metric, noise_type):
    ...
    results_sets, results, thresholds, weighted_coverage, weighted_set_size = calibrate_and_return_performance( classifier, n_classes,  X_test, X_Cal, y_test, y_cal, alpha, class_labels)
    ...
    perturbed_df, ls_pred_sets = produce_performance_metrics_over_multiple_datasets(perturbed_df, classifier, X_test, y_test, y_cal, alpha, class_labels)
